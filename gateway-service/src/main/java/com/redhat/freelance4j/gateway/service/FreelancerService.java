...
public class FreelancerService {
    ...
    public List<Freelancer> getFreelancers() {
        // return JsonObject
        final Response response = freelancerBaseService.request(MediaType.APPLICATION_JSON).get();
     ...
     */
    public Freelancer getFreelancer(final String freelancerId) {
        final Response response = freelancerGetByIdService.resolveTemplate("freelancerId", freelancerId)
    ...
    @PostConstruct
    public void init() {
        freelancerBaseService = ((ResteasyClientBuilder) ClientBuilder.newBuilder()).connectionPoolSize(10).build()
